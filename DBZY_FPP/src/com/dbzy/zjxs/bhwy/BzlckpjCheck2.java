...
import com.dbzy.zjxs.po.BzlckpjPO;

public class BzlckpjCheck2 extends InterruptListener  {
	public BzlckpjCheck2() {
		setDescription("标准临床开票价备案校验2_wzq");
	}
	...
	public boolean execute(ProcessExecutionContext ctx) throws Exception{
		...
		List<BO> datas = boapi.query("BO_DY_ZDZC_BZLCKPJ_S").addQuery("BINDID=", proInsId).list();
		List<BzlckpjPO> kpjList = new ArrayList<>();
		if(datas != null && !datas.isEmpty()) {
			for(BO b : datas) {
				BzlckpjPO bp = new BzlckpjPO();
