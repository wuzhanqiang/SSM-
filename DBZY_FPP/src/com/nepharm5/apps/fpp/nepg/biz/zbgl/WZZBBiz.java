...
public class WZZBBiz extends ExecuteListener implements
	...
	public void execute(ProcessExecutionContext ctx) throws Exception {
		...
		try {
			if(isAgreeOrDispatch(ctx)){
				...
				BO record = SDK.getBOAPI().getByProcess("BO_DY_XZBG_WZZB_P", bindId);
	...
	private void addZBHZInfo(String uid, BO record, String bindId){
		...
		recordData.set("ZBGC", record.get("ZBXM"));//招标项目
	...
	private void addWJPSHZInfo(String uid, BO record, String bindId){
		...
		recordData.set("TM", record.get("ZBXM"));//招标项目
