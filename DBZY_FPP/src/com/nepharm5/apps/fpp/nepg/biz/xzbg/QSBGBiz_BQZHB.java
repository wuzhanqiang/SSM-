...
/**
 * 请示报告批示流程，公司副总审阅节点或者总经办秘书分发批示节点，点击办理时，向文件批示汇总表BO_DY_XZBG_WJPSHZ中添加记录
 * @author Administrator
 *
 */
public class QSBGBiz_BQZHB extends InterruptListener implements InterruptListenerInterface {
