...
public class XHFAKHRoleJumpStep2 implements HumanPerformerInterface {

	public XHFAKHRoleJumpStep2() {
	...
	public String getHumanPerformer(UserContext ctx, ProcessInstance ProcessInstance,
		...
		List<BO> boDatas = SDK.getBOAPI().query("BO_DY_GYGL_JJCBJL_SJSB").bindId(ProcessInstance.getId()).list(); 
		String uid = "";
		for(BO bo:boDatas){
