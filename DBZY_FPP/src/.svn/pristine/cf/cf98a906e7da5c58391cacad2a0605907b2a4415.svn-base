...
public class LccpzdbadrTaskAfterComplete extends ExecuteListener implements ExecuteListenerInterface {

	public LccpzdbadrTaskAfterComplete() {
	...
	public void execute(ProcessExecutionContext ctx) throws Exception {
		...
		boapi.createDataBO("BO_DY_ZDZC_LCZD_P", listMain, userContext);
		boapi.createDataBO("BO_DY_ZDZC_LCZD_P", listSub, userContext);
	}
