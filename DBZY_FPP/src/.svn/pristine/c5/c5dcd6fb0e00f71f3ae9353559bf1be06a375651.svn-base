...
import com.nepharm.apps.fpp.biz.qm.constant.SjfxConstant;

public class SjfxFormGridFilter extends FormGridFilterListener implements
		ValueListenerInterface {

	public SjfxFormGridFilter() {
	}
	...
	public FormGridRowLookAndFeel acceptRowData(
		...
		switch (tableName) {
		//数据分析报告-子表
		case SjfxConstant.TAB_ZLGL_SJFXBG_S:
