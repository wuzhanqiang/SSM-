...
public class SJFXRoleJumpStep2 implements HumanPerformerInterface {

	public SJFXRoleJumpStep2() {
	...
	public String getHumanPerformer(UserContext ctx, ProcessInstance ProcessInstance,
		...
		List<BO> boDatas = SDK.getBOAPI().query("BO_DY_ZLGL_SJFXBG_S").bindId(ProcessInstance.getId()).list(); 
		String uid = "";
		for(BO bo:boDatas){
